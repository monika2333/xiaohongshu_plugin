(() => {
  ...
  const TEXT_SYSTEM = [
    ...
    "返回一个 JSON 对象，不要 Markdown。字段：headline（不含★，概括核心事件）、event_summary（连续正文，只写平台用户、事件经过和必要补充证据；不要写发帖日期、点赞评论数、评论观点或来源链接）、opinion_points（0至3个字符串，每项必须以“部分网民”开头并归纳一类评论观点）。",
