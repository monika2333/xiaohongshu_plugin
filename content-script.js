(() => {
  ...
  const PAGE_SESSION_ID = globalThis.XhsCaptureCommon.ensurePageSessionId("__XHS_NOTE_EXPORTER_PAGE_SESSION_ID__");

  // 消息协议、进度上报与工作流尾部在 capture-common.js，本文件只保留小红书差异逻辑。
